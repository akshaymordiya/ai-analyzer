...
export async function promptForMSHLink(): Promise<string> {
...
export async function promptForConfiguration(): Promise<JiraConfig> {
...
export async function promptForGroqKey(): Promise<string> {
...
export async function promptForApproval(comment: string): Promise<boolean> {
...
export async function promptForModification(comment: string): Promise<string> {
  ...
  function extractJiraComment(raw: string): string {
